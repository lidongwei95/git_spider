...
imgpath = "/home/dongweili/图片"
# filename = "1589261218.jpg"
filename = "1629757569.jpg"

if __name__ == '__main__':
    try:
        if sys.argv[1] in os.listdir(imgpath):
            filename = sys.argv[1]
        else:
            print("please enter the right pic name. Exit.")
            os._exit(0)
    except:
        print("please add the pic name. Exit.")
        os._exit(0)
